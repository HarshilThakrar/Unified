          ...
          >
            <div className="aspect-video bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center">
              <div className="text-center">
                <svg
                  className="w-24 h-24 text-primary opacity-50 mx-auto mb-4"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <p className="text-text-light font-heading font-semibold">
                  Map Integration Placeholder
                </p>
                <p className="text-sm text-text-light mt-2">
                  Replace with your preferred map service (Google Maps, Mapbox, etc.)
                </p>
              </div>
            </div>
          </motion.div>
